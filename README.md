...
## Table of Content
  ...
  * [Credits](#credits)
  ...
  ## Overview
  This is a simple image classification streamlit app trained on the top of Keras API. The trained model (`app/model/model.h5`) takes an image (UBER-FAIR-PRICE-PREDICTION) as an input and predict the class of image from __10, 20, 50, 100, 200, 500, 2000__ denomination.
